  ...
  tagList(
    ...
    fluidRow(
      ...
      column(4,
        ...
        tags$p(class = "help_text", "Voronoi neighbors are the collection of cells that are the nearest seed point in the voronoi diagram in every direction from the index cell."),
